...
namespace DiversityWorkbench.XsltEditor
{
    ...
    internal class ControlMoverOrResizer
    {
        ...
        private static void UpdateMouseEdgeProperties(Control control, Point mouseLocationInControl)
        {
            ...
            MouseIsInLeftEdge = Math.Abs(mouseLocationInControl.X) <= 3;
            MouseIsInRightEdge = Math.Abs(mouseLocationInControl.X - control.Width) <= 3;
            MouseIsInTopEdge = Math.Abs(mouseLocationInControl.Y) <= 3;
            MouseIsInBottomEdge = Math.Abs(mouseLocationInControl.Y - control.Height) <= 3;
        }
        ...
        private static void MoveControl(Control control, MouseEventArgs e) 
        {
            ...
            UpdateMouseEdgeProperties(control, P);

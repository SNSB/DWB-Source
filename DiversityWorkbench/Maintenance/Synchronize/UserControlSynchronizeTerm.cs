...
namespace DiversityWorkbench.Maintenance.Synchronize
{
    public partial class UserControlSynchronizeTerm : UserControl
    {
        ...
        private Maintenance.Synchronize.SynchronizeTerm _SynchronizeTerm;
        private Maintenance.iMaintenanceForm _MaintenanceForm;
        private string _LabelImageSpacer = "      ";

        #endregion

        #region Construction
        public UserControlSynchronizeTerm(SynchronizeTerm synchronizeTerm, iMaintenanceForm maintenanceForm)
        {
            InitializeComponent();
            _SynchronizeTerm = synchronizeTerm;
            this._MaintenanceForm = maintenanceForm;
            this.InitControl();
        ...
        {
            this.labelTableRestriction.Image = _SynchronizeTerm.RestrictionImage;
            this.labelTableRestriction.Text = "      " + _SynchronizeTerm.RestrictionText;
        }
        ...
        private void checkBoxIncludeMainTable_Click(object sender, EventArgs e)
        {
            this.buttonShowDetails.Visible = checkBoxIncludeMainTable.Checked;

            _SynchronizeTerm.IncludeMainTable(this.checkBoxIncludeMainTable.Checked);
        }
        ...
        private void buttonShowDetails_Click(object sender, EventArgs e)
        {
            ...
            if (this.dataGridView.DataSource.GetType() == typeof(System.Data.DataTable))
            {
                ...
                HasValidColumn = dt.Columns.Contains(this._SynchronizeTerm.MainTablePKcolumnName);
            }
            if (HasValidColumn && int.TryParse(this.dataGridView.Rows[Position].Cells[this._SynchronizeTerm.MainTablePKcolumnName].Value.ToString(), out ID))
            {
                this._SynchronizeTerm.ShowDetails(ID, this._MaintenanceForm.FormWidth() - 40, this._MaintenanceForm.FormHeight() - 40);

                //this.Cursor = System.Windows.Forms.Cursors.WaitCursor;
                //DiversityWorkbench.Maintenance.iMaintenanceCheckSingle checkSingle = this._SynchronizeTerm.FormCheckSingle;
                //checkSingle.ShowInMainForm(ID);
        ...
        //private DiversityWorkbench.Maintenance.Synchronize.FormMaintenance _FormMaintenance;
        ...
        //        {
        //            c = c.Parent;
        //            if (c.Parent.GetType() == typeof(DiversityCollection.FormMaintenance))
        //            {
        //                _FormMaintenance = (DiversityCollection.FormMaintenance)c.Parent;
        //                break;
        //            }
        //        }
        //    }

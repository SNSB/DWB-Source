...
{
    public class GfbioTerminologySearchResult : TaxonomicSearchResult
    {
        [JsonPropertyName("results")]
        public GfbioTerminologySearchResultItem[] Result { get; set; }
    ...
    public class GfbioTerminologySearchResultItem : TaxonomicSearchResultItem
    {
        ...
        public override TaxonomicSearchResultItem? GetMappedApiClientModel()
        {
            ...
            string QueryListPrefix = configuration["GfbioTerminology:GfbioTerminology_DetailListPrefix"];
            //             //PESI/term?uri=
            if (string.IsNullOrWhiteSpace(sourceTerminology) || string.IsNullOrEmpty(uri))
                this._URL = "";
            else
                this._URL = QueryListPrefix + sourceTerminology + "/term?uri="+ uri;

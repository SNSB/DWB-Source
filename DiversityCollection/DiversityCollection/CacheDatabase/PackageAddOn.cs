    ...
    public class PackageAddOn
    {
        ...
        public static System.Collections.Generic.Dictionary<AddOn, int> PackageCompatibleVersions()
        {
            if (PackageAddOn._CompatibleVersions == null)
            {
                ...
                PackageAddOn._CompatibleVersions.Add(AddOn.ABCD_BayernFlora, 11); // TODO Ariane: can we outsource the version numbers somewhere so that we only have to change it at one place?
            }

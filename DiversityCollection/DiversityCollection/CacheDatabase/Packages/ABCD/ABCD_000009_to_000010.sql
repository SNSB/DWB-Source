...
-- Publisher
   UPDATE "#project#"."ABCD__ProjectCitation" SET "Citation" = (select concat("Citation", '. Data Publisher: ', MIN(a."AgentName"), '.') 
	...
	WHERE r."AgentRole" = 'Publisher' AND a."AgentName" <> '' AND a."AgentName" = r."AgentName" and a."ProjectID" = r."ProjectID" and a."ProjectID" = (SELECT "#project#".projectid() limit 1) and a."AgentURI" = r."AgentURI");
-- URI
...
UPDATE "#project#"."Package" SET "Version" = 10 WHERE "Package" = 'ABCD'
...
namespace DiversityCollection.Forms
{
    public partial class FormTask : Form
    {
        ...
        private DiversityCollection.Task _Task;
        ...
        public void SetFormAccordingToItem(bool ShowResults = false)
        {
            if (this._Task.ID != null)
            {
                ...
                //if (DiversityCollection.LookupTable.DtTaskResult((int)this._Task.ID).Rows.Count > 0)
                //    ShowResults = true;
                //this.splitContainerResultList.Panel2Collapsed = !ShowResults;


                //this.splitContainerResultList.Panel2Collapsed = false;

                {
                    bool IsModuleRelated = DiversityCollection.Task.IsModuleRelated(this.comboBoxModuleType.Text);
                    //this.userControlModuleRelatedEntryTaskModule.Visible = IsModuleRelated;
                    //this.textBoxResultResult.Visible = !IsModuleRelated;
                    //this.labelResultUri.Visible = !IsModuleRelated;
                    //this.textBoxResultUri.Visible = !IsModuleRelated;
                    if (IsModuleRelated)
                    {
                        Task.TaskModuleType taskType = Task.TypeOfTaskModule(this.comboBoxModuleType.Text);
        ...
        private void setTaskImage()
        {
            if (this.taskBindingSource.Current != null)
            {
                ...
                //this.buttonType.Image = DiversityCollection.Specimen.ImageList.Images[DiversityCollection.Specimen.TaskTypeImage(R["Type"].ToString(), false)];
                this.buttonType.Image = DiversityCollection.Specimen.ImageList.Images[DiversityCollection.Specimen.ImageIndex(R.Row, false)];
            }
            //this.buttonType.Image = DiversityCollection.Task.TaskImage((int)this._Task.ID);
            //if (this.comboBoxType.Text.Length > 0)
            //    this.buttonType.Image = DiversityCollection.Task.TaskImage(this.comboBoxType.Text);
            //else if (this.comboBoxModuleType.Text.Length > 1)
            //    this.buttonType.Image = DiversityCollection.Task.TaskImage(this.comboBoxModuleType.Text);
            //else if (this.comboBoxDateType.Text.Length > 1)
            //    this.buttonType.Image = DiversityCollection.Task.TaskImage(this.comboBoxDateType.Text);
            //else if (this.comboBoxResultType.Text.Length > 1)
            //    this.buttonType.Image = DiversityCollection.Task.TaskImage(this.comboBoxResultType.Text);
            //else
            //    this.buttonType.Image = DiversityCollection.Resource.Task;
        }
        ...
        private void toolStripButtonTaskModuleAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                DiversityCollection.Datasets.DataSetTask.TaskModuleRow R = this.dataSetTask.TaskModule.NewTaskModuleRow();
        ...
        private void toolStripButtonResultAdd_Click(object sender, EventArgs e)
        {
            ...
            if (f.DialogResult == System.Windows.Forms.DialogResult.OK)
            {
                DiversityCollection.Datasets.DataSetTask.TaskResultRow R = this.dataSetTask.TaskResult.NewTaskResultRow();
                R.Result = f.String;
                R.TaskID = (int)this._Task.ID;
        ...
        private void StartWizard()
        {
            ...
            try
            {
                ...
                ImportSteps = this.ImportStepsTask;
                if (ImportSteps == null)

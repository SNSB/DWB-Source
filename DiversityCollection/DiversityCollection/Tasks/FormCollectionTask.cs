...
namespace DiversityCollection.Tasks
{
    public partial class FormCollectionTask : Form
    {
        ...
        private DiversityCollection.Tasks.CollectionTask _CollectionTask;
        ...
        private DiversityCollection.Forms.FormCollectionSpecimen.ViewMode _ViewMode = DiversityCollection.Forms.FormCollectionSpecimen.ViewMode.Default;
        ...
        public FormCollectionTask(int? ID, DiversityCollection.UserControls.iMainForm iMainForm, bool EnableMenu = false)
            : this(iMainForm)
        {
            if (ID != null)
            {
                _ViewMode = Forms.FormCollectionSpecimen.ViewMode.SingleInspectionMode;
            ...
            if (!EnableMenu)
            {
                ...
                this.spreadsheetToolStripMenuItem.Visible = false;
        ...
        private void initForm()
        {
            try
            {
                ...
                this.inituserControlModuleRelatedEntry(ref this.userControlModuleRelatedEntryCollectionImageCreator, A, "CollectionTaskImage", "CreatorAgent", "CreatorAgentURI", this.collectionTaskImageBindingSource);
                this.inituserControlModuleRelatedEntry(ref this.userControlModuleRelatedEntryCollectionImageLicenseHolder, A, "CollectionTaskImage", "LicenseHolder", "LicenseHolderAgentURI", this.collectionTaskImageBindingSource);
                this.inituserControlModuleRelatedEntry(ref this.userControlModuleRelatedEntryResponsibleAgent, A, "CollectionTask", "ResponsibleAgent", "ResponsibleAgentURI", this.collectionTaskBindingSource);
        ...
        {
            // TODO: Diese Codezeile lädt Daten in die Tabelle "dataSetCollectionTask.CollectionTaskMetric". Sie können sie bei Bedarf verschieben oder entfernen.
            //this.collectionTaskMetricTableAdapter.Fill(this.dataSetCollectionTask.CollectionTaskMetric);
        }

        private void FormCollectionTask_FormClosing(object sender, FormClosingEventArgs e)
        {
            bool BuildHierarchy = true;
            if (this._ViewMode == Forms.FormCollectionSpecimen.ViewMode.SingleInspectionMode)
                BuildHierarchy = false;
            this._CollectionTask.saveItem(BuildHierarchy);
                    ...
                    if (collectionTaskBindingSource.Current != null)
                    {
                        ...
                        if (int.TryParse(this._CollectionTask.TaskID.ToString(), out TaskID))
                        {
                            ...
                            if (this.treeViewTask.SelectedNode != null)
                            {
                                ...
                                System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<System.Windows.Forms.ToolStripMenuItem>> newTaskItems = new Dictionary<string, List<ToolStripMenuItem>>();
                                System.Collections.Generic.List<System.Windows.Forms.ToolStripMenuItem> moduleItems = new List<ToolStripMenuItem>();
                                foreach(System.Data.DataRow r in dtTasks.Rows)
                                {
                                    ...
                                    if (!LookupTable.TaskTypeIsModuleRelated(r["Type"].ToString()))//r["ModuleType"].Equals(System.DBNull.Value))
                                    {
                                        System.Windows.Forms.ToolStripMenuItem toolStripMenuItem = new ToolStripMenuItem(r[1].ToString(), i);
                                        this.setToolStripMenuItemNewWithPresetEvent(toolStripMenuItem);
                                        toolStripMenuItem.Tag = iTask.ToString();
                                        toolStripMenuItem.ToolTipText = "Add task of type " + r[1].ToString();
                                        this._CollectionTask.setToolStripMenuItemNewEvent(toolStripMenuItem);
                                        if (newTaskItems.ContainsKey(taskType))
                                        {
                                            newTaskItems[taskType].Add(toolStripMenuItem);
                                        }
                                        else
                                        {
                                            System.Collections.Generic.List<System.Windows.Forms.ToolStripMenuItem> toolStripMenuItems = new List<ToolStripMenuItem>();
                                            toolStripMenuItems.Add(toolStripMenuItem);
                                            newTaskItems.Add(taskType, toolStripMenuItems);
                                        }
                                        ...
                                        //toolStripButton.ToolTipText = "Add task of type " + r[1].ToString();
                                        //this.toolStripHierarchyAdding.Items.Add(toolStripButton);
                                    }
                                    else
                                    {
                                        System.Windows.Forms.ToolStripMenuItem toolStripMenuItem = new ToolStripMenuItem(r["Type"].ToString() + ": " + r[1].ToString(), i);
                                        this.setToolStripMenuItemNewWithPresetEvent(toolStripMenuItem);
                                        toolStripMenuItem.Tag = iTask.ToString();
                                        toolStripMenuItem.ToolTipText = "Add task of type " + r[1].ToString();
                                        this._CollectionTask.setToolStripMenuItemNewEvent(toolStripMenuItem);
                                        moduleItems.Add(toolStripMenuItem);
                                    }
                                }
                                if (newTaskItems.Count > 0)
                                {
                                    foreach(System.Collections.Generic.KeyValuePair<string, System.Collections.Generic.List<System.Windows.Forms.ToolStripMenuItem>> KV in newTaskItems)
                                    {
                                        System.Drawing.Image i = DiversityCollection.Specimen.TaskTypeImage(false, KV.Key);
                                        System.Windows.Forms.ToolStripDropDownButton B = new ToolStripDropDownButton(i);
                                        B.ToolTipText = "Adding new task of type " + KV.Key;
                                        foreach (ToolStripMenuItem toolStripMenuItem in KV.Value)
                                            B.DropDownItems.Add(toolStripMenuItem);
                                        this.toolStripHierarchyAdding.Items.Add(B);
                                    }
                                }
                                if (moduleItems.Count > 0)
                                {
                                    System.Windows.Forms.ToolStripDropDownButton B = new ToolStripDropDownButton(DiversityCollection.Resource.DiversityWorkbench);
                                    B.ToolTipText = "Adding module related tasks";
                                    foreach (ToolStripMenuItem toolStripMenuItem in moduleItems)
                                        B.DropDownItems.Add(toolStripMenuItem);
                                    this.toolStripHierarchyAdding.Items.Add(B);
                                }
                            }
        ...
        public void setToolStripMenuItemNewWithPresetEvent(System.Windows.Forms.ToolStripMenuItem B)
        {
            try
            {
                B.Click += new System.EventHandler(this.toolStripButtonNewWithPreset_Click);
        ...
        {
            if(sender.GetType() == typeof(System.Windows.Forms.ToolStripButton))
            {
            ...
            else if(sender.GetType() == typeof(System.Windows.Forms.ToolStripMenuItem))
            {
                System.Windows.Forms.ToolStripMenuItem ToolStripMenuItem = (System.Windows.Forms.ToolStripMenuItem)sender;
                this._CollectionTask.PresetTaskID = int.Parse(ToolStripMenuItem.Tag.ToString());
            }
        }
        ...
        private void bindModuleControl()
        {
            try
            {
                this.userControlModuleRelatedEntryTaskModule.bindToData("CollectionTask", "DisplayText", "ModuleUri", this.collectionTaskBindingSource);
                switch (_taskModuleType)
                {
                    ...
                    case Task.TaskModuleType.Collection:
                        ...
                        this.userControlModuleRelatedEntryTaskModule.IWorkbenchUnit = (DiversityWorkbench.IWorkbenchUnit)C;
                        break;
        ...
        private void setDateControls(int TaskID)
        {
            try
            {
                ...
                _taskDateType = DiversityCollection.Tasks.Task.TypeOfTaskDate(DateType);
                ...
                switch (_taskDateType)
                {
                    ...
                    case Task.TaskDateType.Date:
                        ...
                        if (this.labelTaskStart.Text.Trim().Length == 0)
                    ...
                    case Task.TaskDateType.DateFromTo:
                        ...
                        if (this.labelTaskEnd.Text.Trim().Length == 0)
        ...
        private void buttonCollection_Click(object sender, EventArgs e)
        {
            if (this.collectionTaskBindingSource.Current != null)
            {
                ...
                {
                    string SQL = "SELECT T.Type FROM CollectionTask C INNER JOIN Task T ON T.TaskID = C.TaskID AND C.CollectionTaskID = " + R["CollectionTaskID"];
                    string Type = DiversityWorkbench.Forms.FormFunctions.SqlExecuteScalar(SQL);
                    SQL = "SELECT H.DisplayText, H.CollectionID FROM [dbo].[CollectionChildNodes] (" + CollectionID.ToString() + ") C INNER JOIN [dbo].[CollectionHierarchyAll] () H ON C.CollectionID = H.CollectionID AND C.Type = '" + Type + "' " +
                        " AND C.CollectionID IN (SELECT CollectionID FROM dbo.ManagerCollectionList()) " +
                        "UNION " +
                        "SELECT H.DisplayText, H.CollectionID FROM [dbo].[Collection] C INNER JOIN [dbo].[CollectionHierarchyAll] () H ON C.CollectionID = " + CollectionID.ToString() + " AND C.CollectionParentID = H.CollectionParentID AND C.Type = '" + Type + "' " +
                        "UNION " +
                        "SELECT H.DisplayText, H.CollectionID FROM[dbo].[CollectionChildNodes] (" + CollectionID.ToString() + ") C INNER JOIN[dbo].[CollectionHierarchyAll] () H ON C.CollectionID = H.CollectionID " +
                        "AND C.CollectionID IN (SELECT CollectionID FROM dbo.ManagerCollectionList()) " +
                        "INNER JOIN TaskType_Enum T ON T.Code = '" + Type + "' AND C.Type = T.ParentCode " +
                        "ORDER BY H.DisplayText";
                    ...
                    {
                        System.Windows.Forms.MessageBox.Show("No collections of type " + Type + " could be found");
                    }
                }
            }
        }
        ...
        private void StartWizard()
        {
            try
            {
                ...
                ImportSteps = Tasks.CollectionTask.ImportStepsCollectionTask;// this.ImportStepsCollectionTask;
                if (ImportSteps == null)
        ...
        //            DiversityCollection.Specimen.ImageForTable("CollectionTask", false),
        //            "TaskStart, TaskEnd, Result, NumberValue, BoolValue,  MetricDescription, MetricSource, MetricUnit");
        ...
        //        // Images
        //        ColumnGroups = new Dictionary<string, DiversityWorkbench.Import.StepColumnGroup>();

        //        DiversityWorkbench.Import.StepColumnGroup GCreator = this.ImportWizardStepColumnGroup("Creator and license",
        //            DiversityCollection.Specimen.ImageForTable("CollectionTaskImage", false),
        //            "CreatorAgent, CreatorAgentURI, IPR, CopyrightStatement, LicenseType, LicenseYear, LicenseHolder, LicenseHolderAgentURI");
        //        ColumnGroups.Add(GCreator.DisplayText, GCreator);

        //        DiversityWorkbench.Import.DataTable DTImages = this.ImportWizardDataTable("CollectionTaskImage", "CollectionTask", "Image", DiversityWorkbench.Import.DataTable.Parallelity.parallel, 2, "", "");
        ...
        //        // Metric
        //        DiversityWorkbench.Import.DataTable DTMetric = this.ImportWizardDataTable("CollectionTaskMetric", "CollectionTask", "Metric", DiversityWorkbench.Import.DataTable.Parallelity.parallel, 3, "", "");
        //        DiversityWorkbench.Import.Step SMetric = DiversityWorkbench.Import.Step.GetStepTemplate(DTMetric, DiversityCollection.Specimen.ImageForTable(DTMetric.TableName, false), 1, false, null);
        //        IS.Add(DTMetric.PositionKey, SMetric);
        ...
        private void setVisibilityOfImagesAndLabel(/*bool ShowImage, bool ShowLabel*/)
        {
            ...
            //this.splitContainerImagesAndData.Panel1Collapsed = header == Header.None;
        ...
        private void InitFlorplanControls()
        {
            ...
            _UserControlGeometry.setState(WpfControls.Geometry.UserControlGeometry.State.ReadOnly);
        }
        ...
        private enum CollectionTaskDetail { Module, ModuleList, Part, Transaction, Result, Number, Bool, Date, DateBegin, DateEnd, Uri, Description, Notes, Responsible, Metric }
        ...
        private System.Collections.Generic.Dictionary<CollectionTaskDetail, System.Windows.Forms.TableLayoutPanel> TaskPanels
        {
            get
            {
                if (this._TaskPanels == null)
                {
                    ...
                    this._TaskPanels.Add(CollectionTaskDetail.Transaction, this.tableLayoutPanelTransaction);
                    this.TaskWidthDivisors.Add(CollectionTaskDetail.Transaction, 1);
                    this.TaskVisible.Add(CollectionTaskDetail.Transaction, false);
                    ...
                    this._TaskPanels.Add(CollectionTaskDetail.Responsible, this.tableLayoutPanelResponsibleAgent);
                    this.TaskWidthDivisors.Add(CollectionTaskDetail.Responsible, 1);
                    this.TaskVisible.Add(CollectionTaskDetail.Responsible, false);

                    this._TaskPanels.Add(CollectionTaskDetail.Metric, this.tableLayoutPanelMetric);
                    this.TaskWidthDivisors.Add(CollectionTaskDetail.Metric, 0);
                    this.TaskVisible.Add(CollectionTaskDetail.Metric, false);
                }
        ...
        private void setDetailControls(int TaskID)
        {
            try
            {
...

                {
                    ...
                    // Transaction
                    this.setTransactionControl(TaskID);
                    ...
                    if (DiversityCollection.LookupTable.TaskModuleType(TaskID).Length > 0)
                    {
                        ...
                        _taskModuleType = DiversityCollection.Tasks.Task.TypeOfTaskModule(ModuleType);
                    ...
                    {
                        this.textBoxDisplayText.Visible = true;
                        this.labelDisplayText.Visible = true;
                        this.labelDisplayText.Text = DiversityCollection.LookupTable.TaskModuleTitle(TaskID) + ":";
                    }
                    ...
                    // Responsible
                    if (DiversityCollection.LookupTable.TaskResponsibleType(TaskID).Length > 0)
                    {
                        this.TaskVisible[CollectionTaskDetail.Responsible] = true;
                        this.labelResponsibleAgent.Text = "      " + DiversityCollection.LookupTable.TaskResponsibleType(TaskID) + ":";
                    }

                    // Metric
                    if (DiversityCollection.LookupTable.TaskMetricType(TaskID).Length > 0)
                    {
                        this.TaskVisible[CollectionTaskDetail.Metric] = true;
                        this.labelMetricType.Text = DiversityCollection.LookupTable.TaskMetricType(TaskID) + ":";
                        string Unit = DiversityCollection.LookupTable.TaskMetricUnit(TaskID);
                        if (Unit.Length > 0)
                        {
                            this.textBoxMetricUnit.Text = Unit;
                            this.textBoxMetricUnit.Enabled = false;
                            //switch(Unit)
                            //{
                            //    case "%":
                            //        this.labelMetricType.Image = Specimen.TaskTypeImage(false, "humidity");
                            //        break;
                            //    case "°C":
                            //        this.labelMetricType.Image = Specimen.TaskTypeImage(false, "temperature");
                            //        break;
                            //    default:
                            //        break;
                            //}
                        }
                        else this.textBoxMetricUnit.Enabled = true;
                    }
        ...
        private void setTaskDetailControlsWidth()
        {
            try
            {
                ...
                foreach (System.Collections.Generic.KeyValuePair<CollectionTaskDetail, bool> KV in this.TaskVisible)
                {
                    if (KV.Key == CollectionTaskDetail.Metric)
                    {
                        this.splitContainerTaskDetails.Panel2Collapsed = !KV.Value;
                    }
                    else
                    {
                        ...
                        if (TaskPanels.ContainsKey(KV.Key))
                        {
                            ...
                            if (KV.Value)
                            {
                                ...
                                if (KV.Key == CollectionTaskDetail.Date)
                                {
                                    ...
                                    {
                                        if (this.labelTaskStart.Text.Length < 6)
                                        {
                                            Divisor = Divisor * 2;
                                            Width = Width / 2;
                                        }
                                    ...
                                    {
                                        if (this.labelTaskStart.Text.Length + this.labelTaskEnd.Text.Length > 26)
                                        {
                                            Divisor = Divisor / 2;
                                            Width = Width * 2;
                                        }
                                ...
                                if (p == pMax - 1)
                                {
                                    this.TaskPanels[KV.Key].Width += Frei;
                                }
                            }
                            else
        ...
        {
            this.Cursor = System.Windows.Forms.Cursors.WaitCursor;
            DiversityCollection.Forms.FormCollectionSpecimen formCollectionSpecimen = new Forms.FormCollectionSpecimen(true);
            this.Cursor = System.Windows.Forms.Cursors.Default;
        ...
        private void buttonSpecimenPartDetails_Click(object sender, EventArgs e)
        {
            ...
            {
                this.Cursor = System.Windows.Forms.Cursors.WaitCursor;
                DiversityCollection.Forms.FormCollectionSpecimen formCollectionSpecimen = new Forms.FormCollectionSpecimen(CollectionSpecimenID, false, false, Forms.FormCollectionSpecimen.ViewMode.SingleInspectionMode, true);
        ...
        {
            this.Cursor = System.Windows.Forms.Cursors.WaitCursor;
            DiversityCollection.Forms.FormTransaction formTransaction = new Forms.FormTransaction(true);
            this.Cursor = System.Windows.Forms.Cursors.Default;
            formTransaction.ShowDialog();
            if (formTransaction.DialogResult == DialogResult.OK)
            {
                int? ID = formTransaction.ID;
                if (ID != null)
                {
                    System.Data.DataRowView R = (System.Data.DataRowView)this.collectionTaskBindingSource.Current;
                    R["TransactionID"] = ID;
                    this.setTransactionControl((int)this._CollectionTask.TaskID);
                }
            }
        }
        ...
        private void buttonTransactionDetails_Click(object sender, EventArgs e)
        {
            ...
            {
                this.Cursor = System.Windows.Forms.Cursors.WaitCursor;
                DiversityCollection.Forms.FormTransaction formTransaction = new Forms.FormTransaction(TransactionID);
                formTransaction.Width = this.Width - 20;
                formTransaction.Height = this.Height - 20;
                this.Cursor = System.Windows.Forms.Cursors.Default;
                formTransaction.ShowDialog();
            }
            else
            {
                System.Windows.Forms.MessageBox.Show("Missing entry for transaction");
            }
        }

        private void setTransactionControl(int TaskID)
        {
            try
            {
                if (DiversityCollection.LookupTable.TaskTransactionType(TaskID).Length > 0)
                {
                    this.TaskVisible[CollectionTaskDetail.Transaction] = true;
                    this.labelTransaction.Text = DiversityCollection.LookupTable.TaskTransactionType(TaskID) + ":";
                    System.Data.DataRowView R = (System.Data.DataRowView)this.collectionTaskBindingSource.Current;
                    if (!R["TransactionID"].Equals(System.DBNull.Value))
                    {
                        System.Data.DataTable dt = new DataTable("Transaction");
                        string SQL = "SELECT * FROM [Transaction] WHERE TransactionID = " + R["TransactionID"].ToString();
                        DiversityWorkbench.Forms.FormFunctions.SqlFillTable(SQL, ref dt);
                        if (dt.Rows.Count == 1)
                        {
                            string Transaction = "";
                            DiversityCollection.HierarchyNode N = new HierarchyNode(dt.Rows[0]);
                            this.textBoxTransaction.Text = Transaction + N.setText().Trim();
                            this.pictureBoxTransaction.Image = DiversityCollection.Specimen.ImageForTransactionType(dt.Rows[0]["TransactionType"].ToString());
                            N = null;
                            //if (this._iMainForm != null)
                            //{
                            //    int PartID;
        ...
        private void buttonMetricSource_Click(object sender, EventArgs e)
        {
            System.Data.DataRowView R = (System.Data.DataRowView)this.collectionTaskBindingSource.Current;

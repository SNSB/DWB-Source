...
{
    public partial class UserControlImportMethodParameter : UserControl
    {
        #region Parameter
        ...
        public UserControlImportMethodParameter()
        {
            InitializeComponent();
        }
        ...
        public void showStepControls(DiversityCollection.Import_Step ImportStep)
        {
            ...
            //    this.tabControlImportSteps.TabPages.Add(this._TabPages[Key]);
                ...
                // test
                //System.Windows.Forms.TabPage TX = new TabPage(Key + " I");
                //this.tabControlImportSteps.TabPages.Add(TX);

                //if (this._TabControls.ContainsKey(Key))
                //{
                //    // aktiviert zu Testzwecken - Ergebis: circular reference, ist so also falsch
                //    //this._TabControls[Key].TabPages.Clear();
                //    //if (this._Import.CurrentPosition == Key && this._TabPages.ContainsKey(Key))
                //    //    this._TabControls[Key].TabPages.Add(this._TabPages[Key]);
                //}
            //}
        }
        ...
        public void AddImportStep()
        {
            ...
            try
            {
                ...
                // Test 
                string Title = "Parameter " + (NextImportStepNumber).ToString();// +"_" + StepKey;
                ...
                DiversityCollection.Import_Step IS = DiversityCollection.Import_Step.GetImportStep(
                    ...
                    DiversityCollection.Specimen.getImage(Specimen.OverviewImageTableOrField.Parameter), null
                    );
        ...
        private void AddStepControlsParameter(System.Windows.Forms.TabPage T, DiversityCollection.Import_Step ImportStep)
        {
            try
            {
                ...
                DiversityCollection.Import_Column ICValue = DiversityCollection.Import_Column.GetImportColumn(
                    ImportStep.StepKey(), ImportStep.TableName(), ImportStep.TableAlias(), "CollectionEventParameterValue", UCValue);
                ...
                DiversityCollection.UserControls.UserControlImport_Column UCparameter = new UserControlImport_Column();
                DiversityCollection.Import_Column ICparameter = DiversityCollection.Import_Column.GetImportColumn
                    (ImportStep.StepKey(), ImportStep.TableName(), ImportStep.TableAlias(), "ParameterID", UCparameter);
                ICparameter.CanBeTransformed = true;
                ICparameter.TypeOfEntry = Import_Column.EntryType.MandatoryList;
                ICparameter.TypeOfFixing = Import_Column.FixingType.Schema;
                ICparameter.TypeOfSource = Import_Column.SourceType.Interface;
                ICparameter.MustSelect = true;
                ICparameter.setLookupTable(dt, "DisplayText", "ParameterID");
                UCparameter.initUserControl(ICparameter, this._Import);
                UCparameter.Dock = DockStyle.Top;
                T.Controls.Add(UCparameter);
        ...
        //    try
        //    {
        //        this.AddStepControlsParameter(T, ImportStep);
        ...
        //        //TabControlIdentification.ImageList = this.tabControlParameter.ImageList;
        ...
        //        //TPname.ImageIndex = this.tabPageParameter.ImageIndex;
        //        //string Title = this.tabPageParameter.Text;

...
CREATE TRIGGER [dbo].[trgUpdProjectMaterialCategory] ON [dbo].[ProjectMaterialCategory] 
FOR UPDATE AS
...
CREATE TRIGGER [dbo].[trgUpdProjectTaxonomicGroup] ON [dbo].[ProjectTaxonomicGroup] 
FOR UPDATE AS
